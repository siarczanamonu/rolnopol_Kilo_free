...
- Preferuj istniejący auth setup projektu.
...
Kilo pozwala rozszerzać zachowanie przez skille definiowane w `SKILL.md`, a dodatkowe mechanizmy customizacji obejmują też rules, instructions i workflows, więc ten skill dobrze nadaje się na centralne miejsce dla standardów projektu. [web:1][web:4]
